...
const API_URL = '/api'; // Keep for the Google link for now
...
const SignInPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // [FIX] Wait for the login process in AuthContext (which fetches user data) to complete before navigating.
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-900">
            <div className="w-full max-w-md p-8 space-y-8 bg-[var(--widget-bg)] rounded-xl shadow-lg border border-[var(--widget-border)] text-center">
                ...
                <a href={`${API_URL}/auth/google`} className="w-full flex items-center justify-center gap-3 bg-gray-700 hover:bg-gray-600 border border-gray-600 text-gray-200 font-semibold py-3 px-4 rounded-lg transition">
